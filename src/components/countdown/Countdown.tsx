...
const Countdown = () => {
  ...
  const TimeUnit = ({ value, label }: { value: number; label: string }) => (
    <div className="flex flex-col items-center">
      <span
        className={`text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-txt_white_p ${styles.animateGlow}`}
      >
  ...
  return (
    <div className="flex flex-col mx-auto justify-center items-center">
      <h1 className=" md:text-lg xl:text-xl mb-6 md:mb-8 xl:mb-10 text-txt_white_p/80">
