...
function About() {
  return (
    <>
      <section
        id="hero"
        className="bg-gradient-to-b  from-shAccent-600/20 via-shAccent-600/60 to-black"
      >
          ...
          <main className="container max-w-7xl pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-16">
            ...
            <div className="flex flex-col-reverse gap-12 pb-8 md:flex-row md:justify-between text-white/90 items-center justify-center ">
              <div className="w-full md:w-7/12  flex flex-col">
                ...
                <p className="text-lg  md:text-xl  text-center md:text-left  xl:text-2xl">
                  ...
                  torneos, tanto nacionales como internacionales. De igual
                  manera promovemos y educamos sobre tecnología, impartiendo
                  cursos, charlas y demostraciones.
                </p>
              </div>
            ...
            <section className="mt-20 md:mt-24 lg:mt-28 font-didacte pb-10">
              ...
              <p className=" max-w-prose md:text-lg lg:text-xl text-center mx-auto md:text-left md:ml-0 mb-10 md:mb-12 xl:mb-16">
                Convertirnos en el mejor club de robótica de toda latinoamérica
                y obtener reconocimiento a nivel mundial. Además de ser un nuevo
